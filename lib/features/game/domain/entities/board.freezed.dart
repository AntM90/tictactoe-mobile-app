...
/// @nodoc
mixin _$Board {
  List<PlayerSymbol?> get cells => throw _privateConstructorUsedError;
...
abstract class $BoardCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<PlayerSymbol?> cells});
}
...
class _$BoardImpl implements _Board {
  const _$BoardImpl({required final List<PlayerSymbol?> cells})
      : _cells = cells;

  factory _$BoardImpl.fromJson(Map<String, dynamic> json) =>
      _$$BoardImplFromJson(json);

  final List<PlayerSymbol?> _cells;
  @override
  List<PlayerSymbol?> get cells {
...
abstract class _Board implements Board {
  const factory _Board({required final List<PlayerSymbol?> cells}) =
      _$BoardImpl;
